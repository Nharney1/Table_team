...
from src.ShotSelectionToSpeaker import ConvertSSToSpeaker
...
def main():
	...
	while True:
		...
		target_x , target_y = computedShot.playerPos
		print(str(target_x) + ' ' + str(target_y))
		print("Desired speaker is " + str(ConvertSSToSpeaker(target_x, target_y)))		
